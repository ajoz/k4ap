...
/**
 * An activity representing a single Feature detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a [FeatureListActivity].
 */
class FeatureDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(FeatureDetailFragment.ARG_ITEM_ID,
                    intent.getStringExtra(FeatureDetailFragment.ARG_ITEM_ID))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(Intent(this, FeatureListActivity::class.java))
            return true
        }
